    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative">
        <div className="text-white flex min-h-screen flex-col items-center justify-center gap-4 px-4 pt-24 pb-10 text-center sm:gap-5 sm:px-6 sm:pt-28 lg:px-8">
          <Button className="group uppercase flex items-center justify-center gap-2 rounded-full border md:p-5 border-white/30 bg-white/10 text-xs font-medium text-primary-foreground backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.25)] transition-all duration-300 hover:bg-white/15 hover:border-white/45 px-5 py-2.5 sm:text-sm">
            <span className="inline-block h-2.5 w-2.5 shrink-0 rounded-full bg-[text-secondary]" />
          ...
          <p className="max-w-sm px-2 text-sm font-normal text-secondary sm:max-w-2xl sm:text-base">
          ...
          <div className="flex w-full flex-col items-center gap-3 px-4 sm:w-auto sm:flex-row sm:gap-5 sm:px-0">
            <Button className="flex w-full items-center justify-center gap-2 rounded-full bg-white p-5 font-semibold text-black sm:w-auto">
              Start Your Project <ArrowRight />
            </Button>
            <Button className="flex w-full items-center justify-center gap-2 rounded-full border border-white/30 bg-white/10 p-5 font-semibold text-white sm:w-auto">
              Explore Solutions
            </Button>
          </div>
        </div>
