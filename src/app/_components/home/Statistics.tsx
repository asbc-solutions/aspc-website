...
const Statistics = () => {
  return (
    <div className="grid grid-cols-2 gap-8 px-4 py-12 text-center sm:gap-10 sm:px-6 md:py-16 lg:grid-cols-4 lg:gap-6 lg:px-8 lg:py-20 bg-white dark:bg-slate-950">
