...
const FeaturedSolution = () => {
  return (
    <div className="bg-[#0D1240] dark:bg-slate-900 text-white flex items-center justify-center gap-20 py-20 px-10 flex-col lg:flex-row">
      <div className="flex flex-col gap-5">
        ...
        <p className="text-secondary dark:text-slate-300 line-clamp-3">
